from controllers.validations_controller import Val_url_youtube
...
#LO COMENTADO BUSCABA EN YOUTUBE Y RETORNABA EL PRIMER ENLACE DE LA BUSQUEDA --- FALLO Y NO DEVUELVE LA URL
@bot.command()
async def youtube(ctx, *, search):
    ...
    if not search_result:
        await ctx.send("Error: No se encontraron resultados")
    else:
        print(search_result)
